...
//*************************************************************
// Rule
//1.  use App\Http\Requests\RoutinesValidation; //Add Controller
//2.  public function store( RoutinesValidation $request ){ //example
//*************************************************************

class RoutinesValidation extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        return [
				...
				"routine_introduction" => "nullable", //string('routine_introduction')->nullable()
				"routine_image" => "nullable", //string('routine_image')->nullable()
