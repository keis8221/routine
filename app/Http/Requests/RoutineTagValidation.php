...
//*************************************************************
// Rule
//1.  use App\Http\Requests\RoutineTagValidation; //Add Controller
//2.  public function store( RoutineTagValidation $request ){ //example
//*************************************************************

class RoutineTagValidation extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        return [
				...
				"tag_id" => "nullable|integer", //integer('tag_id')->nullable()
